                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                @auth()
                                    <form action="{{ route('post.like.store', $post->id) }}" method="POST">
                                        @csrf
                                        <span class="align-items-center">{{ $post->liked_users_count }}</span>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        @auth()
                                            <form action="{{ route('post.like.store', $randomPost->id) }}"
                                                ...
                                                @csrf
                                                <span
                                                    class="align-items-center">{{ $randomPost->liked_users_count }}</span>
                                                <button type="submit" class="border-0 bg-transparent">
                                        ...
                                        @guest()
                                            <div>
                                                <span class="align-items-center">{{ $randomPost->liked_users_count }}</span>
                                                <i class="far fa-heart"></i>
                                            </div>
                                        @endguest
                                    </div>
